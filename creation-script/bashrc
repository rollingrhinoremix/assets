...
alias rhino-config="mkdir ~/.rhino/config/config-script && git clone https://github.com/rollingrhinoremix/rhino-config ~/.rhino/config/config-script/ && sudo bash ~/.rhino/config/config-script/ && rm -rf ~/.rhino/config/config-script"
